...
<head>
  ...
  <title><?php echo $title; ?> - Medicio hospitalzed</title>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="daily_info.php">Daily info</a></li>
          <li><a href="doctors_near.php">Doctor's near you</a></li>
          <li class="drop-down"><a href="">Services</a>
          <ul>
            <li><a href="#">Ambulence Service</a></li>
            <li><a href="hospital_suggest.php">Hospitalzed Service</a></li>
            <li><a href="gravary_service.php">Gravary Details</a></li>
          </ul>
        </li> 
